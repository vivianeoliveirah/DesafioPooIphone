package desafioIphone.controller;
...
public class IphoneController implements MusicPlayerService, PhoneService, BrowserService {
    @Override
    ...
    public static void main(String[] args) {
        IphoneController myPhone = new IphoneController();
        myPhone.playMusic();
        myPhone.call();
        myPhone.displayPage(); 
    }
